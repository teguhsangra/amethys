                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-right">
                        <div class="card card-danger">
                            <div class="card-header">
                                <h4 class="card-title">Invoice No : {{ $invoice->code }}</h4>
                                @if($invoice->has_po == 'Y')
                                <h4 class="card-title">PO No : {{ $invoice->po_number }}</h4>
                                @endif
                            </div>
                            <div class="card-body">
                                <table style="float:right;">
                                    ...
                                    <tr class="text-right">
                                        <td>Date</td>
                                        <td>:</td>
                                        <td>{{date("j M Y",strtotime($invoice->invoice_date))}}</td>
                                    </tr>
                                    <tr>
                                        <td>Due Date</td>
                                        <td>:</td>
                                        <td>{{date("j M Y",strtotime($invoice->due_date))}}</td>
                                    </tr>
                                </table>
                            </div>
                        </div>
