        ...
        <div class="card">
            ...
            <div class="card-body">
                {{ Form::open(array('url' => $form_url, 'method' => $method, 'id' => $form_id, 'enctype' => 'multipart/form-data')) }}
                        ...
                        <div class="col-sm-10 checkbox-radios">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="has_po" onclick="$('#po_number').show();" value="Y" @if(!empty($invoice)) @if($invoice->has_po == 'Y') checked @else @endif @endif
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="has_po" onclick="$('#po_number').hide();" value="N" @if(!empty($invoice)) @if($invoice->has_po == 'N') checked @else @endif @else checked @endif
                    ...
                    <div class="row" id="po_number" style="display:none;">
                    	...
                    	<div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('po_number') ? ' has-error' : '' }}">
                                <input type="text" name="po_number" id="po_number" class="form-control" @if(!empty($invoice)) value="{{$invoice->po_number }}" @endif @if(!empty($proforma)) value="{{ $proforma->po_number }}" @endif>
                                <label class="error">{{ $errors->first('po_number') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="proforma">
                        <label class="col-sm-2 col-form-label">Proforma</label>
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('proforma_id') ? ' has-error' : '' }}">
                                @if(!empty(Request::get('action_status')) || !empty($invoice))
                                    <input type="text" class="form-control" @if($invoice->proforma_id != null) value="{{$invoice->proforma->code}}" @endif readonly>
                                    <input type="hidden" name="proforma_id" id="proforma_id" value="{{$invoice->proforma_id}}">
                                @else
                                    <select class="selectpicker form-control" name="proforma_id" id="proforma_id" data-size="5" data-style="select-with-transition" data-show-subtext="true" data-live-search="true">
                                        <option value="" disabled selected>Select Your Option</option>
                                        @foreach($proformas as $detail)
                                            @php
                                                $selected = '';
                                                if(!empty($invoice)){
                                                    if($invoice->proforma_id == $detail->id){
                                                        $selected = 'selected';
                                                    }
                                                }

                                                if(!empty($proforma)){
                                                    if($proforma->id == $detail->id){
                                                        $selected = 'selected';
                                                    }
                                                }
                                            @endphp
                                ...
                                @endif
                                <label class="error">{{ $errors->first('proforma_id') }}</label>
                            </div>
                        </div>
                    </div>
                                ...
                                <select class="selectpicker form-control" name="company_id" id="company_id" data-size="5" data-style="select-with-transition" data-show-subtext="true" data-live-search="true">
                                    ...
                                    @foreach($company as $detail)
                                        @php
                                            $selected = '';
                                            if(!empty($invoice)){
                                                if($invoice->company_id == $detail->id){
                                                    $selected = 'selected';
                                                }
                                            }
                                            if(!empty($proforma)){
                    ...
                    <div class="row" id="bank account">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('bank_account_id') ? ' has-error' : '' }}">
                                @if(!empty(Request::get('action_status')))
                                    <input type="text" class="form-control" value="{{$invoice->bank_account->name}}" readonly>
                                    <input type="hidden" name="bank_account_id" id="bank_account_id" value="{{$invoice->bank_account_id}}">
                                @else
                                <select class="selectpicker form-control" name="bank_account_id" id="bank_account_id" data-size="5" data-style="select-with-transition" data-show-subtext="true" data-live-search="true">
                                    ...
                                    @foreach($bank_accounts as $detail)
                                        @php
                                            $selected = '';
                                            if(!empty($invoice)){
                                                if($invoice->bank_account_id == $detail->id){
                                                    $selected = 'selected';
                                                }
                                            }
                                            if(!empty($proforma)){
                                ...
                                @endif
                                <label class="error">{{ $errors->first('bank_account_id') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="row" id="location">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('location_id') ? ' has-error' : '' }}">
                                @if(!empty(Request::get('action_status')) || !empty($invoice))
                                    <input type="text" class="form-control" value="{{$invoice->location->name}}" readonly>
                                    <input type="hidden" name="location_id" id="location_id" value="{{$invoice->location_id}}">
                                @else
                                    <select class="selectpicker form-control" name="location_id" id="location_id" data-size="5" data-style="select-with-transition" data-show-subtext="true" data-live-search="true">
                                        ...
                                        @foreach($locations as $detail)
                                            @php
                                                $selected = '';
                                                if(!empty($invoice)){
                                                    if($invoice->location_id == $detail->id){
                                                        $selected = 'selected';
                                                    }
                                                }
                                                if(!empty($proforma)){
                                    ...
                                    <select class="selectpicker form-control" name="customer_id" id="customer_id" data-size="5" data-style="select-with-transition" data-show-subtext="true" data-live-search="true">
                                        ...
                                        @foreach($customers as $detail)
                                            @php
                                                $selected = '';
                                                if(!empty($invoice)){
                                                    if($invoice->customer_id == $detail->id){
                                                        $selected = 'selected';
                                                    }
                                                }
                                                if(!empty($proforma)){
                    ...
                    <div class="row" id="customer_contact" @if(empty($invoice)) style='display:none' @endif>
                        <label class="col-sm-2 col-form-label">Customer Contact</label>
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('customer_id') ? ' has-error' : '' }}">
                                @if(!empty(Request::get('action_status')))
                                    <input type="text" class="form-control" value="{{$invoice->contact->name}}" readonly>
                                    <input type="hidden" name="contact_id" id="contact_id" value="{{$invoice->contact_id}}">
                                @else
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('detail_status') ? ' has-error' : '' }}">
                                <select class="selectpicker form-control" name="detail_status" id="detail_status" data-size="5" data-style="select-with-transition" data-show-subtext="true">
                                    ...
                                    <option value="Y" @if(!empty($proforma)) @if($proforma->detail_status == "Y") selected @endif @endif @if(!empty($invoice)) @if($invoice->detail_status == "Y") selected @endif @endif>Show Detail</option>
                                    <option value="N" @if(!empty($proforma)) @if($proforma->detail_status == "N") selected @endif @endif @if(!empty($invoice)) @if($invoice->detail_status == "N") selected @endif @endif>Not Show</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('custom_status') ? ' has-error' : '' }}">
                                <select class="selectpicker form-control" name="custom_status" id="custom_status" data-size="5" data-style="select-with-transition" data-show-subtext="true">
                                    <option value="">Please select one</option>
                                    <option value="Y" @if(!empty($proforma)) @if($proforma->custom_status == "Y") selected @endif @endif @if(!empty($invoice)) @if($invoice->custom_status == "Y") selected @endif @endif @if(!empty(Request::get('type'))) @if(Request::get('type') == 'booking' || Request::get('order')) selected @endif @endif>Custom</option>
                                    <option value="N" @if(!empty($proforma)) @if($proforma->custom_status == "N") selected @endif @endif @if(!empty($invoice)) @if($invoice->custom_status == "N") selected @endif @endif @if(!empty(Request::get('type'))) @if(Request::get('type') == 'booking_detail' || Request::get('order_detail')) selected @endif @endif>Not Custom</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('address_status') ? ' has-error' : '' }}">
                                <select class="selectpicker form-control" name="address_status" id="address_status" data-size="5" data-style="select-with-transition" data-show-subtext="true">
                                    <option value="">Please select one</option>
                                    <option value="location" @if(!empty($invoice)) @if($invoice->address_status == "location") selected @endif @else selected @endif>Location</option>
                                    <option value="customer" @if(!empty($invoice)) @if($invoice->address_status == "customer") selected @endif @endif >Customer</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('invoice_date') ? ' has-error' : '' }}">
                                <input type="text" name="invoice_date" id="invoice_date" class="form-control datepicker" @if(!empty($invoice)) value="{{ date('m/d/Y', strtotime($invoice->invoice_date)) }}" @elseif(!empty($proforma)) value="{{ date('m/d/Y', strtotime($proforma->proforma_date)) }}" @else value="{{ date('m/d/Y') }}" @endif>
                                <label class="error">{{ $errors->first('invoice_date') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('due_date') ? ' has-error' : '' }}">
                                <input type="text" name="due_date" id="due_date" class="form-control datepicker" @if(!empty($invoice)) value="{{ date('m/d/Y', strtotime($invoice->due_date)) }}" @endif @if(!empty($proforma)) value="{{ date('m/d/Y', strtotime($proforma->due_date)) }}" @endif>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 checkbox-radios">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="has_deduction" id="has_deduction" onclick="$('#deduction_price').show();" value="Y" @if(!empty($invoice)) @if($invoice->has_deduction == 'Y') checked @else @endif @else checked  @endif
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="has_deduction" id="has_deduction" onclick="$('#deduction_price').hide();" value="N" @if(!empty($invoice)) @if($invoice->has_deduction == 'N') checked @else @endif @else checked  @endif
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-group bmd-form-group">
                                                <select class="selectpicker form-control" name="selection" id="selection_from" data-size="5" data-style="select-with-transition" data-show-subtext="true">
                                                    <option value="">Please select one</option>
                                                    <option value="booking" @if(!empty($invoice)) @if(!empty($invoice->booking_id)) selected @endif @endif @if(!empty($proforma)) @if(!empty($proforma->booking_id)) selected @endif @endif>Booking</option>
                                                    <option value="order" @if(!empty($invoice)) @if(!empty($invoice->order_id)) selected @endif @endif @if(!empty($proforma)) @if(!empty($proforma->order_id)) selected @endif @endif>Order</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group bmd-form-group">
                                                <input type="text" class="form-control text-right" id="format_custom_price"
                                                    onchange="changeToCurrencyFormat('format_custom_price','custom_price');"
                                                        @if(!empty($invoice)) value="{{ number_format($invoice->total_price, 0, ',', '.') }}" @endif
                                                ...
                                                <input type="hidden" class="form-control" name="custom_price" id="custom_price"
                                                    @if(!empty($invoice)) value="{{ $invoice->total_price }}" @endif
                                                    @if(!empty($proforma)) value="{{ $proforma->total_price }}" @endif />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="form-group bmd-form-group">
                                                <input type="text" class="form-control text-right" id="format_custom_service_charge"
                                                    onchange="changeToCurrencyFormat('format_custom_service_charge','custom_service_charge');"
                                                        @if(!empty($invoice)) value="{{ number_format($invoice->total_service_charge, 0, ',', '.') }}" @endif
                                                ...
                                                <input type="hidden" class="form-control" name="custom_service_charge" id="custom_service_charge"
                                                    @if(!empty($invoice)) value="{{ $invoice->total_service_charge }}" @endif
                                                    @if(!empty($proforma)) value="{{ $proforma->total_service_charge }}" @endif />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <label class="col-sm-3 col-form-label">Total VAT Price</label>
                                        <div class="col-sm-9">
                                            <div class="form-group bmd-form-group">
                                                <input type="text" class="form-control text-right" id="format_custom_tax_price"
                                                    onchange="changeToCurrencyFormat('format_custom_tax_price','custom_tax_price');"
                                                        @if(!empty($invoice)) value="{{ number_format($invoice->total_tax_price, 0, ',', '.') }}" @endif
                                                        @if(!empty($proforma)) value="{{ number_format($proforma->total_tax_price, 0, ',', '.') }}" @endif />
                                                <input type="hidden" class="form-control" name="custom_tax_price" id="custom_tax_price"
                                                    @if(!empty($invoice)) value="{{ $invoice->total_tax_price }}" @endif
                            ...
                            <div class="form-group bmd-form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills nav-pills-warning" id="myTab" role="tablist">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" id="ma-daily-tab"  data-toggle="tab" href="#ma-daily" role="tab" aria-controls="doc" aria-selected="false">Regular Office</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content tab-space">
                                        ...
                                        <div class="tab-pane" id="ma-daily" role="tabpanel" aria-labelledby="ma-daily-tab">
                                            <div class="card">
                                                <div class="card-header">
                                        ...
                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr style="display: none">
                                                    ...
                                                    <td class="text-right">
                                                        <input type="text" class="form-control text-right" id="format_stamp_duty" onchange="changeToCurrencyFormat('format_stamp_duty','stamp_duty');setDetailTransaction();" @if(!empty($invoice)) value="{{ number_format($invoice->stamp_duty, 0, ',' ,'.') }}" @else value="0" @endif />
                                                        <input type="hidden" class="form-control" name="stamp_duty" id="stamp_duty" @if(!empty($invoice)) value="{{ $invoice->stamp_duty }}" @else value="0" @endif />
                                                    </td>
                                                </tr>
                                                <tr style="display: none">
                                                ...
                                                <tr id="deduction_price" style="display:none;">
                                                    ...
                                                    <td class="text-right">
                                                        <input type="text" class="form-control text-right" id="format_deduction_price" onchange="changeToCurrencyFormat('format_deduction_price','deduction_price_text');setDetailTransaction();" @if(!empty($invoice)) value="{{ number_format($invoice->deduction_price, 0, ',' ,'.') }}" @else value="0" @endif />
                                                        <input type="hidden" class="form-control" name="deduction_price" id="deduction_price_text" @if(!empty($invoice)) value="{{ $invoice->deduction_price }}" @else value="0" @endif />
                                                    </td>
                                                    </td>
                                                </tr>
                                                <tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                                <textarea class="form-control" rows="5" name="desc" id="desc" placeholder="Description..." @if(!empty(Request::get('action_status'))) readonly  @endif>@if(!empty($invoice)){{ $invoice->desc }}@endif @if(!empty($proforma)){{ $proforma->desc }}@endif</textarea>
                            </div>
                        </div>
...
<script>
    ...
    function continueTransaction(status_name){
        ...
        if(!isEmpty(document.getElementById("contact_id"))){
            ...
            contact_id = document.getElementById("contact_list").value;
        }
        ...
        if(custom_status == ""){ // Cek Customer
            ...
            if(custom_status == 'Y'){
                if(selection_from == ''){
                    error_list +=   '<div class="alert alert-warning">'+
                                        '<span><b> Sorry !!! You have to select source for custom invoice</b> </span>'+
                                    '</div>';
                }else{
                    switch(selection_from){
                        case 'booking':
                            if(booking_id == ''){
                                error_list +=   '<div class="alert alert-warning">'+
                                                    '<span><b> Sorry !!! You have to select booking for this source custom invoice</b> </span>'+
                                                '</div>';
                            }
                        break;
                        case 'order':
                            if(order_id == ''){
                                error_list +=   '<div class="alert alert-warning">'+
                                                    '<span><b> Sorry !!! You have to select order for this source custom invoice</b> </span>'+
                                                '</div>';
                            }
                        break;
                    }
                    ...
                    if(desc == ''){
                        error_list +=   '<div class="alert alert-warning">'+
                                            '<span><b> Sorry !!! You have to input description for custom invoice</b> </span>'+
                                        '</div>';
                    }
                }
            }else{
    ...
    $(function() {
        $("#proforma_id").change(function() {
            url = '{{ url($url) }}';
            location.href = url+'/create?proforma_id='+$(this).val();
        });
                ...
                for(var i=0; i < data.length; i++){
                    ...
                    @if(!empty($invoice))
                        @if(!empty($invoice->contact_id))
                            if(data[i]['id'] == {{ $invoice->contact_id }}){
                                selected = 'selected';
                            }
                        @endif
                    @endif
    ...
    function getInvoiceData(){
        ...
        if(location_id != '' && customer_id != ''){
            var url = link+"?location_id="+location_id+"&customer_id="+customer_id+"&id="+id+"&proforma_id="+proforma_id;
            $.get(url, function (data){
                ...
                for(var i=0; i < data.bookings.length; i++){
                    ...
                    @if(!empty($invoice))
                        if(data.bookings[i]['id'] == '{{ $invoice->booking_id }}'){
                ...
                for(var i=0; i < data.orders.length; i++){
                    var order_selected = '';
                    @if(!empty($invoice))
                        if(data.orders[i]['id'] == '{{ $invoice->order_id }}'){
    ...
    function loadData(){
        ...
        var total_auto_check_serviced_office = 0;
        var total_auto_check_virtual_office = 0;
        var total_auto_check_coworking = 0;
        ...
        for(var i = 0; i < serviced_offices.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(serviced_offices[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            if (serviced_offices[i].term_of_payment > total_auto_check_serviced_office) {
                checked = 'checked';
                total_auto_check_serviced_office++;
            }
            ...
            detail_serviced_office += '<tr>';
                detail_serviced_office += '<td class="text-center">';
                    detail_serviced_office += '<div class="form-check">';
                        detail_serviced_office += '<label class="form-check-label">';
                            detail_serviced_office += '<input class="form-check-input" type="checkbox" value="'+serviced_offices[i].id+'" id="serviced_office_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_serviced_office += '<td class="text-left">';
                    detail_serviced_office += '<p>Date : '+moment(serviced_offices[i].start_date).format('Do MMM  YYYY')+' to '+moment(serviced_offices[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_serviced_office += '<p>Time : '+serviced_offices[i].start_time+' to '+serviced_offices[i].end_time+'</p>';
                    detail_serviced_office += '<input type="hidden" value="'+moment(serviced_offices[i].start_date).format('Do MMM  YYYY')+' to '+moment(serviced_offices[i].end_date).format('Do MMM  YYYY')+'" id="serviced_office_date_'+i+'" >';
        ...
        for(var i = 0; i < virtual_office.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(virtual_office[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            if (virtual_office[i].term_of_payment > total_auto_check_virtual_office) {
                checked = 'checked';
                total_auto_check_virtual_office++;
            }
            ...
            detail_virtual_office += '<tr>';
                detail_virtual_office += '<td class="text-center">';
                    detail_virtual_office += '<div class="form-check">';
                        detail_virtual_office += '<label class="form-check-label">';
                            detail_virtual_office += '<input class="form-check-input" type="checkbox" value="'+virtual_office[i].id+'" id="virtual_office_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_virtual_office += '<td class="text-left">';
                    detail_virtual_office += '<p>Date : '+moment(virtual_office[i].start_date).format('Do MMM  YYYY')+' to '+moment(virtual_office[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_virtual_office += '<p>Time : '+virtual_office[i].start_time+' to '+virtual_office[i].end_time+'</p>';
                    detail_virtual_office += '<input type="hidden" value="'+moment(virtual_office[i].start_date).format('Do MMM  YYYY')+' to '+moment(virtual_office[i].end_date).format('Do MMM  YYYY')+'" id="virtual_office_date_'+i+'" >';
        ...
        for(var i = 0; i < meeting_room.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(meeting_room[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            detail_meeting_room += '<tr>';
                detail_meeting_room += '<td class="text-center">';
                    detail_meeting_room += '<div class="form-check">';
                        detail_meeting_room += '<label class="form-check-label">';
                            detail_meeting_room += '<input class="form-check-input" type="checkbox" value="'+meeting_room[i].id+'" id="meeting_room_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_meeting_room += '<td class="text-left">';
                    detail_meeting_room += '<p>Date : '+moment(meeting_room[i].start_date).format('Do MMM  YYYY')+' to '+moment(meeting_room[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_meeting_room += '<p>Time : '+meeting_room[i].start_time+' to '+meeting_room[i].end_time+'</p>';
                    detail_meeting_room += '<input type="hidden" value="'+moment(meeting_room[i].start_date).format('Do MMM  YYYY')+' to '+moment(meeting_room[i].end_date).format('Do MMM  YYYY')+'" id="meeting_room_date_'+i+'" >';
        ...
        for(var i = 0; i < coworking.length; i++){
            var checked = '';
             @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(coworking[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            if (coworking[i].term_of_payment > total_auto_check_coworking) {
                checked = 'checked';
                total_auto_check_coworking++;
            }
            ...
            detail_coworking += '<tr>';
                detail_coworking += '<td class="text-center">';
                    detail_coworking += '<div class="form-check">';
                        detail_coworking += '<label class="form-check-label">';
                            detail_coworking += '<input class="form-check-input" type="checkbox" value="'+coworking[i].id+'" id="coworking_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_coworking += '<td class="text-left">';
                    detail_coworking += '<p>Date : '+moment(coworking[i].start_date).format('Do MMM  YYYY')+' to '+moment(coworking[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_coworking += '<p>Time : '+coworking[i].start_time+' to '+coworking[i].end_time+'</p>';
                    detail_coworking += '<input type="hidden" value="'+moment(coworking[i].start_date).format('Do MMM  YYYY')+' to '+moment(coworking[i].end_date).format('Do MMM  YYYY')+'" id="coworking_date_'+i+'" >';
        ...
        for(var i = 0; i < hotel.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(hotel[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            detail_hotel += '<tr>';
                detail_hotel += '<td class="text-center">';
                    detail_hotel += '<div class="form-check">';
                        detail_hotel += '<label class="form-check-label">';
                            detail_hotel += '<input class="form-check-input" type="checkbox" value="'+hotel[i].id+'" id="hotel_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_hotel += '<td class="text-left">';
                    detail_hotel += '<p>Date : '+moment(coworking[i].start_date).format('Do MMM  YYYY')+' to '+moment(coworking[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_hotel += '<p>Time : '+hotel[i].start_time+' to '+hotel[i].end_time+'</p>';
                    detail_hotel += '<input type="hidden" value="'+moment(coworking[i].start_date).format('Do MMM  YYYY')+' to '+moment(coworking[i].end_date).format('Do MMM  YYYY')+'" id="hotel_date_'+i+'" >';
        ...
        for(var i = 0; i < regular_offices.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_detail_id != null)
                        if(regular_offices[i].id == '{{ $invoice_detail->booking_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            detail_regular_office += '<tr>';
                detail_regular_office += '<td class="text-center">';
                    detail_regular_office += '<div class="form-check">';
                        detail_regular_office += '<label class="form-check-label">';
                            detail_regular_office += '<input class="form-check-input" type="checkbox" value="'+regular_offices[i].id+'" id="regular_office_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_regular_office += '<td class="text-left">';
                    detail_regular_office += '<p>Date : '+moment(regular_offices[i].start_date).format('Do MMM  YYYY')+' to '+moment(regular_offices[i].end_date).format('Do MMM  YYYY')+'</p>';
                    detail_regular_office += '<p>Time : '+regular_offices[i].start_time+' to '+regular_offices[i].end_time+'</p>';
                    detail_regular_office += '<input type="hidden" value="'+moment(regular_offices[i].start_date).format('Do MMM  YYYY')+' to '+moment(regular_offices[i].end_date).format('Do MMM  YYYY')+'" id="regular_office_date_'+i+'" >';
        ...
        for(var i = 0; i < order_details.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->order_detail_id != null)
                        if(order_details[i].id == '{{ $invoice_detail->order_detail_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            detail_order_detail += '<tr>';
                detail_order_detail += '<td class="text-center">';
                    detail_order_detail += '<div class="form-check">';
                        detail_order_detail += '<label class="form-check-label">';
                            detail_order_detail += '<input class="form-check-input" type="checkbox" value="'+order_details[i].id+'" id="order_detail_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_order_detail += '<td class="text-left">';
                    detail_order_detail += '<p>Date : '+moment(order_details[i].order_date).format('Do MMM  YYYY')+'</p>';
                    detail_order_detail += '<input type="hidden" value="'+moment(order_details[i].order_date).format('Do MMM  YYYY')+'" id="order_detail_date_'+i+'" >';
                detail_order_detail += '</td>';
                detail_order_detail += '<td class="text-center">';
        ...
        for(var i = 0; i < cancellations.length; i++){
            ...
            @if(!empty($invoice))
                @foreach($invoice->invoice_detail as $invoice_detail)
                    @if($invoice_detail->booking_cancellation_id != null)
                        if(cancellations[i].id == '{{ $invoice_detail->booking_cancellation_id }}'){
                            checked = 'checked';
                        }
                    @endif
                @endforeach
            ...
            detail_cancellation += '<tr>';
                detail_cancellation += '<td class="text-center">';
                    detail_cancellation += '<div class="form-check">';
                        detail_cancellation += '<label class="form-check-label">';
                            detail_cancellation += '<input class="form-check-input" type="checkbox" value="'+cancellations[i].id+'" id="cancellation_id_'+i+'" '+checked+' onchange="checkInvoiceData()">';
                ...
                detail_cancellation += '<td class="text-left">';
                    detail_cancellation += '<p>Date : '+moment(cancellations[i].start_date).format('Do MMM  YYYY')+'</p>';
        ...
        @if(!empty($invoice) || !empty($proforma))
            checkInvoiceData();
        @endif
            ...
            $.get(url_list, function (data){
                for(var i=0; i < data.proformas.length; i++){
                    ...
                    proforma_detail_by_reference += '<tr>';
                        proforma_detail_by_reference += '<td>'+data.proformas[i].code+'</td>';
                        proforma_detail_by_reference += '<td>'+numberWithCommas(data.proformas[i].total_price)+'</td>';
                        proforma_detail_by_reference += '<td>'+numberWithCommas(data.proformas[i].total_service_charge)+'</td>';
                        proforma_detail_by_reference += '<td>'+numberWithCommas(data.proformas[i].total_tax_price)+'</td>';
                        proforma_detail_by_reference += '<td>'+numberWithCommas(sub_total)+'</td>';
                    proforma_detail_by_reference += '</tr>';
                }
                ...
                for(var i=0; i < data.invoices.length; i++){
                    ...
                    invoice_detail_by_reference += '<tr>';
                        invoice_detail_by_reference += '<td>'+data.invoices[i].code+'</td>';
                        invoice_detail_by_reference += '<td>'+numberWithCommas(data.invoices[i].total_price)+'</td>';
                        invoice_detail_by_reference += '<td>'+numberWithCommas(data.invoices[i].total_service_charge)+'</td>';
                        invoice_detail_by_reference += '<td>'+numberWithCommas(data.invoices[i].total_tax_price)+'</td>';
                        invoice_detail_by_reference += '<td>'+numberWithCommas(sub_total)+'</td>';
                    invoice_detail_by_reference += '</tr>';
                }
    ...
    function checkInvoiceData(){
        ...
        for(var i = 0; i < serviced_offices.length; i++){
            ...
            if(check_status){
                ...
                invoice_details.push(new_array);
            }
        }
        for(var i = 0; i < virtual_office.length; i++){
    ...
    function getDeposit(){
        ...
        if(customer_id != ''){
            var url = link+"/"+customer_id+"?proforma_id="+proforma_id+"&invoice_id="+invoice_id;
            $.get(url, function (data){
                for(var i=0; i < data.length; i++){
    ...
    function setDetailTransaction(){
        ...
        var row_invoice_details = '';
        var row_deposit_details = '';

        for(var i = 0; i < invoice_details.length; i++){
            row_invoice_details += '<tr>';
                row_invoice_details += '<td><a class="btn btn-danger" onclick="removeInvoiceDetail('+i+','+invoice_details[i].array_index+','+"'"+invoice_details[i].type+"'"+')"><i class="fa fa-times"></i></a></td>';
                row_invoice_details += '<td>'+invoice_details[i].type_name+'</td>';
                row_invoice_details += '<td>';
                    row_invoice_details += '<p> Description: '+invoice_details[i].desc+'</p>';
                    row_invoice_details += '<p> Date: '+invoice_details[i].date+'</p>';
                    row_invoice_details += '<p> Time: '+invoice_details[i].time+'</p>';
                    row_invoice_details += '<p> Remarks: '+invoice_details[i].remarks+'</p>';
                    row_invoice_details += '<input type="hidden" name="booking_detail_id[]" value="'+invoice_details[i].booking_detail_id+'">';
                    row_invoice_details += '<input type="hidden" name="order_detail_id[]" value="'+invoice_details[i].order_detail_id+'">';
                    row_invoice_details += '<input type="hidden" name="booking_cancellation_id[]" value="'+invoice_details[i].booking_cancellation_id+'">';
                    row_invoice_details += '<input type="hidden" name="name[]" value="'+invoice_details[i].name+'">';
                    row_invoice_details += '<input type="hidden" name="detail_price[]" value="'+parseFloat(invoice_details[i].detail_price)+'">';
                    row_invoice_details += '<input type="hidden" name="detail_service_charge[]" value="'+parseFloat(invoice_details[i].detail_service_charge)+'">';
                    row_invoice_details += '<input type="hidden" name="detail_tax_price[]" value="'+parseFloat(invoice_details[i].detail_tax_price)+'">';
                    row_invoice_details += '<input type="hidden" name="detail_remarks[]" value="'+invoice_details[i].remarks+'">';
                row_invoice_details += '</td>';
                row_invoice_details += '<td class="text-right">'+numberWithCommas(Math.round(invoice_details[i].detail_price))+'</td>';
                row_invoice_details += '<td class="text-right">'+numberWithCommas(Math.round(invoice_details[i].detail_service_charge))+'</td>';
                row_invoice_details += '<td class="text-right">'+numberWithCommas(Math.round(invoice_details[i].detail_tax_price))+'</td>';
                row_invoice_details += '<td class="text-right">'+numberWithCommas(Math.round(invoice_details[i].detail_price + invoice_details[i].detail_service_charge + invoice_details[i].detail_tax_price))+'</td>';

            row_invoice_details += '</tr>';

            total_price = parseFloat(total_price) + parseFloat(invoice_details[i].detail_price);
            
            total_service_charge = parseFloat(total_service_charge) + parseFloat(invoice_details[i].detail_service_charge);
            total_tax = parseFloat(total_tax) + parseFloat(invoice_details[i].detail_tax_price);
        }
        ...
        document.getElementById("row_invoice_details").innerHTML = row_invoice_details;
        ...
        document.getElementById("view_round_price").value = numberWithCommas(parseInt(round_price));
    ...
    function removeInvoiceDetail(array_index, array_index_of_type, type){
        ...
        invoice_details.splice(array_index);
        checkInvoiceData();
    }
</script>
@endsection
