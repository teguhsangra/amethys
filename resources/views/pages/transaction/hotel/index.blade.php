            ...
            <div class="card-body">
                ...
                <div class="tab-content tab-space">
                    ...
                    <div class="tab-pane material-datatables table-responsive @if($no == 0) active @endif" id="booking_{{ $status->id }}">
                        <table id="hotels_{{ $status->id }}-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            <thead>
                                <tr>
                                    <th>Code</th>
                                    <th>Employee</th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" name="back_url" value="hotel">
...
<script>
    ...
    $(function() {
        @foreach($statuses as $no => $status)
	    $('#hotels_{{ $status->id }}-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ...
	        columns: [
	            ...
	            { data: 'status_name', name: 'status_name' },
	            {
	            	...
	            	"render" : function(row, data, full){
                        ...
                        return_html += ' <a rel="tooltip" class="btn btn-round btn-default" title="Edit Contact" href="'+booking_contact_url+'?back_url=hotel&menu_name=Hotel&booking_id='+id+'"><i class="material-icons">assignment_ind</i></a>';
