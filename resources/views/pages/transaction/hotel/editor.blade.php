            ...
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">
                    ...
                    <a href="{{ url($url) }}" class="btn btn-rose pull-right">
                        <i class="fa fa-arrow-left"></i> Back To Hotel
                    </a>
                </h4>
            </div>
            <div class="card-body">
                {{ Form::open(array('url' => $form_url, 'method' => $method, 'id' => $form_id, 'enctype' => 'multipart/form-data')) }}
                    ...
                    <div class="row" id="breakfast_status_selection">
                        <label class="col-sm-2 col-form-label">Breakfast Status</label>
                        <div class="col-sm-10 checkbox-radios">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="breakfast_status" id="breakfast_status" value="Y" onclick="setDetailTransaction()" checked> Yes
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="breakfast_status" id="breakfast_status" value="N" onclick="setDetailTransaction()"> No
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
                    ...
                    <div class="row" id="main_agreement_selection"  style="display:none">
                        <label class="col-sm-2 col-form-label">Main Agreement</label>
                        <div class="col-sm-10 checkbox-radios" >
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="is_main_agreement" id="is_main_agreement" onclick="showTerm()" value="Y"  @if(!empty($booking)) @if($booking->is_main_agreement == 'Y') checked @endif @endif checked> Yes
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
                            ...
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="radio" name="is_main_agreement" id="is_main_agreement" onclick="showTerm()" value="N"  @if(!empty($booking)) @if($booking->is_main_agreement == 'N') checked @endif @endif> No
                                    <span class="circle">
                                        <span class="check"></span>
                                    </span>
                                </label>
                    ...
                    <input type="hidden" name="start_date_counted" id="start_date_counted" value="N">
                    ...
                    <div class="row" id="term_of_payment" style="display:none">
                            ...
                            <div class="form-group bmd-form-group{{ $errors->has('term_of_payment') ? ' has-error' : '' }}">
                                <select  name="term_of_payment" id="term_of_payment"  data-size="5" data-style="select-with-transition" data-show-subtext="true"
                                    ...
                                    <option value="6" @if(!empty($booking)) @if($booking->term_of_payment == 6) selected @endif @endif
                                         @if(!empty($inquiry)) @if($inquiry->term_of_payment == 6) selected @endif @endif>Semi-Annually</option>
                                    <option value="12" @if(!empty($booking)) @if($booking->term_of_payment == 12) selected @endif @endif
                                        @if(!empty($inquiry)) @if($inquiry->term_of_payment == 12) selected @endif @endif>Annually</option>
                                </select>
                    ...
                    <div class="row" id="term_notice_period" style="display:none">
                    ...
                    <div class="row" id="free_term_booking_view" style="display:none">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10">
                            <div class="form-group bmd-form-group{{ $errors->has('remarks') ? ' has-error' : '' }}">
                                <textarea class="form-control" rows="5" name="remarks" id="remarks" placeholder="Remarks..." @if(!empty(Request::get('action_status'))) readonly  @endif>@if(!empty($inquiry)){{ $inquiry->remarks }}@endif @if(!empty($booking)){{ $booking->remarks }}@endif</textarea>
...
<script>
    ...
    function getDedicated(){
        ...
        if(location_id != ''){
            ...
            $.get(url, function (data){
                ...
                document.getElementById("dedicated_phone_list").innerHTML = product_list;
    ...
    function setDetailTransaction(){
        ...
        var breakfast_status = $("input[name=breakfast_status]:checked").val();
        ...
        for(var i=0; i < selected_room.length; i++){
            ...
            switch(price_type){
                ...
                case 'daily':
                    ...
                    if(breakfast_status == "N"){
                        room_price = selected_room[i].daily_exclude_breakfast_price;
                    }
                break;
                case 'monthly':
    ...
    function resetPeriode(){
        ...
        document.getElementById("start_time").value = "{{ date('H:i', strtotime($hotel_start_time.':00:00')) }}";
        document.getElementById("end_time").value = "{{ date('H:i', strtotime($hotel_end_time.':00:00')) }}";
