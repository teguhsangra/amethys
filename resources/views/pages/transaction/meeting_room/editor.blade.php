                    ...
                    <div class="row" id="start_to_end">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="signed_date" id="signed_date" class="form-control datepicker text-center" placeholder="Order Date" @if(!empty($booking)) value="{{ date('m/d/Y', strtotime($booking->signed_date)) }}" @endif>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function continueTransaction(status_name){
        ...
        var url_availability = link_availability+"?type=room&array_room_id="+array_room_id+"&start_date="+start_date+"&end_date="+end_date+"&start_time="+start_time+"&end_time="+end_time+"&booking_id="+booking_id+"&price_type="+price_type;
