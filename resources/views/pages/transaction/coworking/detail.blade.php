@extends('layouts.app')
@section('title')
Rakomsis Workstation - {{ $booking->code }}
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">Detail Workstation</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <table width="100%" class="table table-bordered" style="vertical-align: center;">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    ...
                                    @if($booking->price_type == "monthly")
                                    Months<br>
                                    @else
                                    {{ $booking->price_type }}<br>
                                    @endif
                        ...
                        <table width="100%" class="table table-bordered" style="vertical-align: center;">
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="padding-top: 1px;padding-bottom: 1px;">
                                    <b>Rp {{ number_format($total_price - $discount_price, 0, ',', '.') }}</b>
                                </td>
                            </tr>
                            @php
                            ...
                            <tr>
                                ...
                                <td class="text-right" style="padding-top: 1px;padding-bottom: 1px;">
                                    <b>Rp {{ number_format($total_price + $total_service_charge + $total_tax_price + $booking->total_additional_charge + $booking->total_service_charge_additional_charge + $booking->total_tax_additional_charge + $booking->security_deposit + $booking->stamp_duty + $booking->round_price, 0, ',', '.') }}</b>
                                </td>
                            </tr>
                        </table>
