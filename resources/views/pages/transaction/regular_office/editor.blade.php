...
@section('title')
Rakomsis Regular Office - Editor
@endsection
            ...
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">
                    ...
                    <a href="{{ url($url) }}" class="btn btn-rose pull-right">
                        <i class="fa fa-arrow-left"></i> Back To Regular Office
                    </a>
                </h4>
            </div>
            <div class="card-body">
                {{ Form::open(array('url' => $form_url, 'method' => $method, 'id' => $form_id, 'enctype' => 'multipart/form-data')) }}
                    ...
                    <div class="row" id="term_of_payment" >
...
<script>
    ...
    function setFurniture(){
        ...
        if(selected_furniture.length > 0){
            ...
            for(var i=0; i < selected_furniture.length; i++){
                ...
                furniture += '<td class="text-center" colspan="4"><input type="number" class="form-control text-center" name="fu_quantity[]" id="fu_quantity'+furniture_id+'" min="1" value="'+furniture_quantity+'" onchange="countFurniture()"></td>';
    ...
    function setDetailTransaction(){
        ...
        var is_main_agreement = $("input[name=is_main_agreement]:checked").val();
        ...
        for(var i=0; i < selected_room.length; i++){
            ...
            if(is_main_agreement == "Y"){
                    detail_transaction += '<td><input type="hidden" name="detail_use_complimentary[]" class="form-control text-center" id="total_use_complimentary_'+room_id+'" value="0" readonly></td>';
            }else{
