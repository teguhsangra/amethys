    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">Parameter Setting</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
                ...
                <div class="material-datatables">
                    <table id="parameter_settings-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Int Value</th>
...
<script>
    $(function() {
	    $('#parameter_settings-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url('datatables/'.$url) }}',
	        columns: [
	            { data: 'name', name: 'name' },
	            { data: 'int_value', name: 'int_value' },
	            { data: 'double_value', name: 'double_value' },
	            { data: 'string_value', name: 'string_value' },
	            { data: 'text_value', name: 'text_value' },
	            {
	            	sortable:false,
