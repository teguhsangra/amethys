        ...
        <div class="card">
            ...
            {{ Form::open(array('url' => $form_url, 'method' => $method, 'id' => $form_id, 'enctype' => 'multipart/form-data')) }}
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            <input type="text" name="code" class="form-control" @if(!empty($location)) value="{{ $location->code }}" @else value="{{ $code }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <input type="text" name="name" class="form-control" @if(!empty($location)) value="{{ $location->name }}" @else value="{{ old('name') }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            <input type="text" name="phone" class="form-control" @if(!empty($location)) value="{{ $location->phone }}" @else value="{{ old('phone') }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('fax') ? ' has-error' : '' }}">
                            <input type="text" name="fax" class="form-control" @if(!empty($location)) value="{{ $location->fax }}" @else value="{{ old('fax') }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            <textarea id="mytextarea" class="form-control" rows="9" name="address">@if(!empty($location)){{ $location->address }}@endif</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('latitude') ? ' has-error' : '' }}">
                            <input type="text" name="latitude" class="form-control" @if(!empty($location)) value="{{ $location->latitude }}" @else value="{{ old('latitude') }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('longitude') ? ' has-error' : '' }}">
                            <input type="text" name="longitude" class="form-control" @if(!empty($location)) value="{{ $location->longitude }}" @else value="{{ old('longitude') }}" @endif>
