        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="material-datatables">
                    <table id="access_groups-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Name</th>
	        ...
	        columns: [
	            ...
	            { data: 'name', name: 'name' },
	            {
	            	...
	            	"render" : function(row, data, full){
	            		...
	            		'<a href='+url+'/manage/'+id+' rel="tooltip"  class="btn btn-round btn-default" title="Manage"><i class="material-icons">build</i></a> '+
