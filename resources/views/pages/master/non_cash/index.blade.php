    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">Non Cash</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
                ...
                <div class="material-datatables table-responsive">
                    <table id="non_cashs-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Name</th>
    ...
    $(function() {
	    $('#non_cashs-table').DataTable({
	        ...
	        columns: [
	            { data: 'code', name: 'code' },
	            { data: 'name', name: 'name' },
	            { data: 'has_bank', name: 'has_bank' },
	            { data: 'has_card', name: 'has_card' },
	            {
	            	sortable:false,
