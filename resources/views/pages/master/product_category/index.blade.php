        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="material-datatables table-responsive">
                    <table id="product_categories-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Name</th>
...
<script>
    $(function() {
	    $('#product_categories-table').DataTable({
	        processing: true,
	        serverSide: true,
