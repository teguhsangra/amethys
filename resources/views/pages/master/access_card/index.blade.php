        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="material-datatables table-responsive">
                    <table id="access_cards-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Location</th>
                                <th>Code</th>
