@extends('layouts.app')
@section('title')
Rakomsis Photo Product - {{ $product->name }}
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-default card-header-icon">
                ...
                <h4 class="card-title">Photo Product</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ $product->name }}'s Photo</h4>
            </div>
            <div class="card-body">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header card-header-default card-header-icon">
                ...
                <h4 class="card-title">New Product Photo</h4>
            </div>
            <div class="card-body">
...
<script>
    $(function() {
	    $('#products-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url('datatables/'.$url.'/photo/'.$product->id) }}',
	        columns: [
	            {
	            	sortable:false,
	            ...
	            },
	            {
	            	sortable:false,
	            	"render" : function(row, data, full){
	            		var url = "{{ url('product/photo/change_status') }}";
	            		var id = full.id;
