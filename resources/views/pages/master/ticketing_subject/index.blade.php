    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-info card-header-icon">
                ...
                <h4 class="card-title">Ticketing Subject</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
                ...
                <div class="material-datatables table-responsive">
                    <table id="ticketing_subjects-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Code</th>
                                <th>Name</th>
...
<script>
    $(function() {
	    $('#ticketing_subjects-table').DataTable({
	        processing: true,
	        serverSide: true,
