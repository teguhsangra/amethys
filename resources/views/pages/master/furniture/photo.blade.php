@extends('layouts.app')
@section('title')
Rakomsis Photo Furniture - {{ $furniture->name }}
@endsection
@section('content')
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-default card-header-icon">
                ...
                <h4 class="card-title">Photo Furniture</h4>
            </div>
            <div class="card-body">
                <div class="toolbar">
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ $furniture->name }}'s Photo</h4>
            </div>
            <div class="card-body">
                <div class="material-datatables">
                    <table id="furnitures-table" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                        <thead>
                            <tr>
                                <th>Photo</th>
    ...
    <div class="col-md-6">
        <div class="card">
            <div class="card-header card-header-default card-header-icon">
                ...
                <h4 class="card-title">New Furniture Photo</h4>
            </div>
            <div class="card-body">
...
<script>
    $(function() {
	    $('#furnitures-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ url('datatables/'.$url.'/photo/'.$furniture->id) }}',
	        columns: [
	            {
	            	sortable:false,
	            ...
	            },
	            {
	            	sortable:false,
	            	"render" : function(row, data, full){
	            		var url = "{{ url('furniture/photo/change_status') }}";
	            		var id = full.id;
    ...
    function changeStatus(link, id, default_status){
        ...
        $.get(url, function (data){
            $('#furnitures-table').DataTable().ajax.reload();
        });
    }
