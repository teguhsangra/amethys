    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">Room Type Form</h4>
            </div>
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                            <input type="text" name="code" class="form-control" @if(!empty($room_type)) value="{{ $room_type->code }}" @else value="{{ $code }}" @endif>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="form-group bmd-form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <input type="text" name="name" class="form-control" @if(!empty($room_type)) value="{{ $room_type->name }}" @else value="{{ old('name') }}" @endif>
