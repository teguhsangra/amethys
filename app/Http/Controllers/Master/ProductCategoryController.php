...
class ProductCategoryController extends Controller
{
    ...
    private $form_id = 'product_category_form';
    private $table_name = 'product_categories';
    private $prefix_name = 'PC';
    /**
    ...
    public function index()
    {
        ...
        return view('pages.master.product_category.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('pages.master.product_category.editor', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            $product_category->created_by = Auth::user()->name;
    ...
    public function show($id)
    {
        ...
        return view('pages.master.product_category.detail', $data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'code' => 'required|unique:product_categories,code,'.$product_category->id,
            'name' => 'required',
        ]);
        ...
        if ($validator->fails()) {
            ...
            $product_category->code = $request['code'];
            $product_category->name = $request['name'];
            $product_category->updated_by = Auth::user()->name;
            if($product_category->save()){
    ...
    public function datatables(){
        ...
        return DataTables::of($product_categories)->make(true);
    }
}
