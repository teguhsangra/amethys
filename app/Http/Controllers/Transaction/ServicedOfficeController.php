...
class ServicedOfficeController extends Controller
{
    private $url = 'serviced_office';
    private $form_id = 'serviced_office_form';
    private $table_name = 'bookings';
    private $prefix_name = 'SO';
    private $ids = array();
    ...
    public function index()
    {
        ...
        return view('pages.transaction.serviced_office.index', $data);
    }
    ...
    public function create()
    {
        ...
        $room_category = RoomCategory::where('code', 'SO')->first();
        ...
        return view('pages.transaction.serviced_office.editor', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if(empty($request['free_term_booking'])) $request['free_term_booking'] = 0;
    ...
    public function show($id)
    {
        ...
        return view('pages.transaction.serviced_office.detail', $data);
    }
