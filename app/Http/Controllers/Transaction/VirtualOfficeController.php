...
{
    private $url = 'virtual_office';
    private $form_id = 'virtual_office_form';
    private $table_name = 'bookings';
    private $prefix_name = 'VO';
    private $ids = array();
    ...
    public function __construct()
    {
        ...
        $this->term_and_conditions_18_op = MarketingMaterial::where('code', '18op_vo_tnc')->first();
        $this->term_and_conditions_ssc = MarketingMaterial::where('code', 'ssc_vo_tnc')->first();
    ...
    public function index()
    {
        ...
        $data['product'] = Product::where('main_status', 'Y')->get();
        $data['url'] = $this->url;
        ...
        return view('pages.transaction.virtual_office.index', $data);
    }
    ...
    public function create()
    {
        ...
        $data['inquiries'] = Inquiry::whereIn('status_id', $active_status_id)->where('type', 'product')->whereIn('employee_id', $this->ids)->get();
        $data['bank_accounts'] = BankAccount::get();

        return view('pages.transaction.virtual_office.editor', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.transaction.virtual_office.detail', $data);
    }
    ...
    public function print($id)
    {
        ...
        $data['service_charge'] = $this->service_charge;
        $data['director_name'] = $this->director_name->string_value;
        return view('pages.transaction.virtual_office.print', $data);
    }
    ...
    public function datatables()
    {
        ...
        if ($location_id != null && $product_id != null) {
            $bookings = Booking::join('statuses', 'statuses.id', 'bookings.status_id')
                ...
                ->select('bookings.*', 'statuses.name as status_name', 'employees.name as employee_name', 'employees.id as employee_id', 'customers.name as customer_name', 'products.name as product_name', 'locations.name as location_name')
