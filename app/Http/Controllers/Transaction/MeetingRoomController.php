...
{
    private $url = 'meeting_room';
    private $form_id = 'meeting_room_form';
    private $table_name = 'bookings';
    private $prefix_name = 'MR';
    private $ids = array();
    ...
    public function __construct()
    {
        ...
        $this->terms_conditions = MarketingMaterial::where('code', 'term_and_conditions')->first();
    ...
    public function index()
    {
        ...
        $meetings = [];
        if ($location_id != null) {
            $event = Booking::join('statuses', 'statuses.id', 'bookings.status_id')
        ...
        $data['meeting'] = Calendar::addEvents($meetings);
        return view('pages.transaction.meeting_room.index', $data);
    }
    ...
    public function create()
    {
        ...
        $room_category = RoomCategory::where('code', 'MR')->first();
        ...
        return view('pages.transaction.meeting_room.editor', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if ($booking->save()) {
                ...
                if ($status->action == "draft" && $booking->is_main_agreement == "Y") {
    ...
    public function show($id)
    {
        ...
        return view('pages.transaction.meeting_room.detail', $data);
    }
    ...
    public function print($id)
    {
        ...
        $data['service_charge'] = $this->service_charge;
        $data['director_name'] = $this->director_name->string_value;
        return view('pages.transaction.meeting_room.print', $data);
    }
