...
class RegularOfficeController extends Controller
{
    private $url = 'regular_office';
    private $form_id = 'regular_office_form';
    ...
    public function index()
    {
        ...
        return view('pages.transaction.regular_office.index', $data);
    }
    ...
    public function create()
    {
        ...
        $room_category = RoomCategory::where('code', 'RO')->first();
        ...
        return view('pages.transaction.regular_office.editor', $data);
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.transaction.regular_office.detail', $data);
    }
    ...
    public function print($id)
    {
        ...
        $data['service_charge'] = $this->service_charge;
        $data['director_name'] = $this->director_name->string_value;
        return view('pages.transaction.regular_office.print', $data);
    }
